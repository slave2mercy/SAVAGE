...
async def setgame(ctx, *, game):
    """Sets my game (Owner)"""
    if ctx.message.author.id == ('459175543154147328'):
        message = ctx.message
...
async def kick(ctx, *, member : discord.Member = None):
    ...
    embed.set_footer(text="Nice Bot® v1.0")
...
client.run('NTE4ODU3MTY0NDA0NTU1Nzc4.DuW3Uw.WwOM7EZUHCxBoBZJZW-kwzZuO8w')
